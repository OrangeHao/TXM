...
import routeplan.R;
import routeplan.R2;
import routeplan.adapter.BusPathAdapter;
import routeplan.adapter.BusSegmentListAdapter;
import routeplan.behavior.AnchorBottomSheetBehavior;
...
public class BusRouteResultActivity extends AppCompatActivity {
    ...
    @BindView(R2.id.route_plan_map)
    MapView mMapView;
    @BindView(R2.id.bus_paths_bottom_sheet)
    NestedScrollView mNestScrollView;
    @BindView(R2.id.bus_paths_viewpage)
    ViewPager mViewPager;
    @BindView(R2.id.bus_segment_list)
...
//                Log.d("bottomsheet-", "slideOffset:"+slideOffset);
    ...
    private void initSheet(){
        ...
        for (BusPath path:mRouteResult.getPaths()){
            View view= LayoutInflater.from(mContext).inflate(R.layout.layout_pager_item_busresult,null);
